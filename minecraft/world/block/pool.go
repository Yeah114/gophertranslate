...
var initEntries = []initEntry{
	{protocol.Version1v16v100, v1v16v100.Init},
	{protocol.Version1v16v210, v1v16v210.Init},
	{protocol.Version1v17v0, v1v17v0.Init},
	{protocol.Version1v17v10, v1v17v10.Init},
	{protocol.Version1v17v30, v1v17v30.Init},
	{protocol.Version1v17v40, v1v17v40.Init},
	{protocol.Version1v18v10, v1v18v10.Init},
	{protocol.Version1v18v30, v1v18v30.Init},
	{protocol.Version1v19v0, v1v19v0.Init},
	{protocol.Version1v19v20, v1v19v20.Init},
	{protocol.Version1v19v50, v1v19v50.Init},
	{protocol.Version1v19v60, v1v19v60.Init},
	{protocol.Version1v19v70, v1v19v70.Init},
	{protocol.Version1v19v80, v1v19v80.Init},
	{protocol.Version1v20v0, v1v20v0.Init},
	{protocol.Version1v20v10, v1v20v10.Init},
	{protocol.Version1v20v30, v1v20v30.Init},
	{protocol.Version1v20v40, v1v20v40.Init},
	{protocol.Version1v20v50, v1v20v50.Init},
	{protocol.Version1v20v60, v1v20v60.Init},
	{protocol.Version1v20v70, v1v20v70.Init},
	{protocol.Version1v20v80, v1v20v80.Init},
	{protocol.Version1v21v0, v1v21v0.Init},
	{protocol.Version1v21v20, v1v21v20.Init},
	{protocol.Version1v21v30, v1v21v30.Init},
	{protocol.Version1v21v40, v1v21v40.Init},
	{protocol.Version1v21v50, v1v21v50.Init},
	{protocol.Version1v21v60, v1v21v60.Init},
	{protocol.Version1v21v70, v1v21v70.Init},
	{protocol.Version1v21v80, v1v21v80.Init},
	{protocol.Version1v21v90, v1v21v90.Init},
	{protocol.Version1v21v100, v1v21v100.Init},
	{protocol.Version1v21v110, v1v21v110.Init},
	{protocol.Version1v21v120, v1v21v120.Init},
	{protocol.Version1v21v124, v1v21v124.Init},
	{protocol.Version1v21v130, v1v21v130.Init},
	{protocol.Version1v26v0, v1v26v0.Init},
	{protocol.Version1v26v10, v1v26v10.Init},
	{protocol.Version1v26v20v26, v1v26v20v26.Init},
	{protocol.Version1v26v20, v1v26v20.Init},
	{"full", full.Init},
}

func Init(before func(string)) {
